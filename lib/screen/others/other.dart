...
import 'package:flutter_app/screen/become_seller.dart';
import 'package:flutter_app/screen/favourites.dart';
...
class _OthersState extends State<Others> {
  ...
  getPref() async {
    ...
    if (token == null) {
      ...
      final responseData = await http.get(
          Uri.parse(baseurl + version + profile),
          headers: {'Auth': token!});
      if (responseData.statusCode == 200) {
        final data = responseData.body;
        final listservices = jsonDecode(data)['content']['mProfile'];
  ...
  getstatus() async {
    ...
    final responseDatastatus = await http.get(
        Uri.parse(baseurl + version + statuscheck),
        headers: {'Auth': token!});
          ...
          Column(
            children: <Widget>[
              Container(
                  ...
                  height: 180,
                  decoration: new BoxDecoration(
                    color: Color.fromARGB(255, 55, 188, 124),
                  ),
