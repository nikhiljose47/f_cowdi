...
class _OthersState extends State<Others> {
  ...
  getPref() async {
    ...
    if (token == null) {
      ...
      final responseData = await http.get( baseurl + version + profile, headers: {'Auth': token});
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListTile(
              ...
              title:  apiinforlist.length != 0 ? Text('Join '+ apiinforlist[0].appName):Text(""),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: onWillPop,
        child: Scaffold(body: othersec(context)));
  }
}
