  ...
  void _uploadFile(filePath) async {
    ...
    if (filePath != null) {
      ...
      try {
        ...
        Response response = await Dio().post(baseurl + version  + sendmsg ,data: formData, options: Options(
          headers: {
            ...
            ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Center(child: Text(datacard.postTitle,style: TextStyle(
                          color: primarycolor,
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(datacard.sellerName,style: TextStyle(
                                    color: Colors.black,
                                  ...
                                  Container(
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          Text("#" + datacard.orderNumber,style: TextStyle(
                                            color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Container(
                                            ...
                                            child: Center(child: Text("Iteam",style: TextStyle(
                                              color: primarycolor,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text("Duration",style: TextStyle(
                                              color: primarycolor,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Container(
                                            ...
                                            child: Center(child: Text(datacard.postTitle,style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderDuration,style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.itemPrice,style: TextStyle(
                                              color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Container(
                                            ...
                                            child: Center(child: Text("Processing",style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderFee,style: TextStyle(
                                              color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderPrice,style: TextStyle(
                                              color: Colors.black,
                    ...
                    children: <Widget>[
                                      ...
                                      Row (
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Text(listcat.senderName,  style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 16,
                                              ),),),
                                            Container(
                                                child: Text(listcat.dateTime ,  style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 14,
                                                ),)),
                                          ]),
                      ...
                      Form(
                          ...
                          child: Container(
                            ...
                            padding: EdgeInsets.only(top: 0.0, bottom: 0.0, right: 5.0, left: 5.0),
