...
class _supportState extends State<support>{
  ...
  void _openFileExplorer() async {
    ...
    try {
      FilePickerResult? result = await FilePicker.platform.pickFiles(type: _pickingType as FileType, allowedExtensions: [_extension as String]);
      _path = result!.files.first.path.toString();
  ...
  Future<Null> getData() async {
    ...
    if (responseData.statusCode == 200) {
      ...
      final listservices = jsonDecode(data)['content']['typesArr'];
      setState(() {
